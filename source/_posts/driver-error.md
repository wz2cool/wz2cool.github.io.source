...
{% asset_img img_v3_02si_1be0cf4f-95e2-4b9e-9bcc-54b95495816g.jpg "驱动蓝屏错误" %}
...
2. 从官方下的镜像可能会更好，现在怀疑i tell you win10 的镜像可能存在不兼容的问题，具体原因不清楚。
3. 我不是很清楚这次升级是不是仍然使用了 win7 的显卡驱动才没有问题，所以后面重装的的话也还是从win7 升级到win10 保险点。